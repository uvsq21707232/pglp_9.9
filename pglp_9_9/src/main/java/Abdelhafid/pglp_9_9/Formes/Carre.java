...
public class Carre extends Forme {
	 ...
	 * 
	 * @param cote
	 *            La nouvelle longueur de la côte du carré.
	 */
	 ...
	 * 
	 * @param centre
	 *            Le nouveau point au centre du carré.
	 */
	 ...
	 * 
	 * @param a
	 *            la valeur à ajoutée à l'abscisse du point bas_gauche du carré.
	 * @param b
	 *            la valeur à ajoutée à l'ordonées du point bas_gauche du carré.
	 **/
	...
	public void affiche_forme() {
		...
		System.out.println(
				"Carre(point_centre=(" + centre_carre.getX() + "," + centre_carre.getY() + "),Côte=" + cote + ")");
